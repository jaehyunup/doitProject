      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <h2 class="section-title">안녕하세요,  <%=name %> 님</h2>
            <p class="section-lead">
              	다른 두잇터들에게 관심을 살만할 프로필을 작성해보세요!
            </p>
              ...
              <div class="col-12 col-md-12 col-lg-5">
                <div class="card profile-widget">
                  <div class="profile-widget-header">
                    <img alt="image" src="<c:url value="/resources/images/avatar-1.png"/>" class="rounded-circle profile-widget-picture">
                    <div class="profile-widget-items">
                      <div class="profile-widget-item">
                        <div class="profile-widget-item-label">참여한 프로젝트</div>
                      ...
                      <div class="profile-widget-item">
                        ...
                        <div class="profile-widget-item-value">877</div>
                      </div>
                    </div>
                  </div>
