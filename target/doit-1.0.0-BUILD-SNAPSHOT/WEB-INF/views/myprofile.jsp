		...
		<div class="main-wrapper">
			...
			<div class="main-content">
				<section class="section">
					...
					<div class="section-body">
						...
						<p class="section-lead">자신만의 독특한 프로필을 꾸며서 다른 두잇터들에게 자신을
							어필해보세요!</p>
							...
							<div class="col-12 col-md-12 col-lg-5">
								<div class="card profile-widget">
									...
									<div class="profile-widget-description">
										<div class="profile-widget-name" style="color: #444;">${profile.nickname}
										...
										<!-- 자기소개 -->
										<div class="profilesection" id="p_introduce"
											style="display: inline;">
											<div class="profile-widget-name"
												style="font-family: 'Noto Sans KR'; color: #333; margin-top: 12%;">자기소개</div>
											<div class="profilesection" id="p_intro"
												style="color: #333; padding: 10px; color: #555;">${profile.introduce}</div>
										</div>
										<!-- 관심분야 -->
										<div class="profilesection" id="p_filed">
											<div class="profile-widget-name" style="color: #333;">보유기술</div>

										</div>
										<!-- 경력 -->
										<div class="profilesection" id="p_spec">
											<div class="profile-widget-name" style="color: #333;">경력
												사항</div>
										</div>
										<!-- 학력 및 전공 -->
										<div class="profilesection" id="p_edumajor">
											<div class="profile-widget-name" style="color: #333;">학력/전공</div>
										</div>
										<!-- 보유자격증 -->
										<div class="profilesection" id="p_certificate">
											<div class="profile-widget-name" style="color: #333;">보유
												자격증</div>
										</div>
										...
										<div class="card-body">
											<div class="row">
												<div class="form-group col-md-6 col-12">
													<label>닉네임</label> <input id="nickname" name="nickname"
														type="text" class="form-control"
														value="${profile.nickname}" required="">
													<div class="invalid-feedback">닉네임이 틀렸습니다</div>
												</div>
												<div class="form-group col-md-6 col-12">
											...
											<div class="row">
												<div class="form-group">
													<label>관심직군</label> <select name="position" id="position"
														class="form-control">
												...
												<div class="form-group col-12 col-md-12">
													...
													<div class="selectgroup selectgroup-pills">
														<label class="selectgroup-item"> <input
															type="checkbox" id="filed" name="filed" value="Python"
															class="selectgroup-input"> <span
															class="selectgroup-button">Python</span>
														</label> <label class="selectgroup-item"> <input
															type="checkbox" id="filed" name="filed" value="Java"
															class="selectgroup-input"> <span
															class="selectgroup-button">Java</span>
														</label> <label class="selectgroup-item"> <input
															type="checkbox" id="filed" name="filed" value="Spring"
															class="selectgroup-input"> <span
															class="selectgroup-button">Spring</span>
														</label> <label class="selectgroup-item"> <input
															type="checkbox" id="filed" name="filed" value="Andorid"
															class="selectgroup-input"> <span
															class="selectgroup-button">Android</span>
														</label> <label class="selectgroup-item"> <input
															type="checkbox" id="filed" name="filed" value="Swift"
															class="selectgroup-input"> <span
															class="selectgroup-button">Swift</span>
														</label> <label class="selectgroup-item"> <input
															type="checkbox" id="filed" name="filed" value="Web"
															class="selectgroup-input"> <span
															class="selectgroup-button">Web</span>
														</label> <label class="selectgroup-item"> <input
															type="checkbox" id="filed" name="filed" value="App"
															class="selectgroup-input"> <span
															class="selectgroup-button">App</span>
														</label> <label class="selectgroup-item"> <input
															type="checkbox" id="filed" name="filed" value="Design"
															class="selectgroup-input"> <span
															class="selectgroup-button">Design</span>
														</label> <label class="selectgroup-item"> <input
															type="checkbox" id="filed" name="filed" value="UX/UI"
															class="selectgroup-input"> <span
															class="selectgroup-button">UX/UI</span>
														</label> <label class="selectgroup-item"> <input
															type="checkbox" id="filed" name="filed" value="iOS"
															class="selectgroup-input"> <span
															class="selectgroup-button">iOS</span>
														</label> <label class="selectgroup-item"> <input
															type="checkbox" id="filed" name="filed" value="Linux"
															class="selectgroup-input"> <span
															class="selectgroup-button">Linux</span>
														</label> <label class="selectgroup-item"> <input
															type="checkbox" id="filed" name="filed" value="프로그래밍"
															class="selectgroup-input"> <span
															class="selectgroup-button">프로그래밍</span>
														</label> <label class="selectgroup-item"> <input
															type="checkbox" id="filed" name="filed" value="C++"
															class="selectgroup-input"> <span
															class="selectgroup-button">C++</span>
														</label> <label class="selectgroup-item"> <input
															type="checkbox" id="filed" name="filed" value="C"
															class="selectgroup-input"> <span
															class="selectgroup-button">C</span>
														</label> <label class="selectgroup-item"> <input
															type="checkbox" id="filed" name="filed" value="Ruby"
															class="selectgroup-input"> <span
															class="selectgroup-button">Ruby</span>
														</label> <label class="selectgroup-item"> <input
															type="checkbox" id="filed" name="filed"
															value="Tensorflow" class="selectgroup-input"> <span
															class="selectgroup-button">Tensorflow</span>
														</label> <label class="selectgroup-item"> <input
															type="checkbox" id="filed" name="filed" value="Keras"
															class="selectgroup-input"> <span
															class="selectgroup-button">Keras</span>
														</label> <label class="selectgroup-item"> <input
															type="checkbox" id="filed" id="filed" name="filed"
															value="OpenCV" class="selectgroup-input"> <span
															class="selectgroup-button">OpenCV</span>
														</label>
												...
												<div class="form-group col-md-12 col-12">
													...
													<div class="input-group">
														<input name="spec" type="text" class="form-control"
															placeholder="" aria-label="" id="spectext">
														<div class="input-group-append">
															<button class="btn btn-primary" type="button" value=""
																id="specAddBtn">추가하기</button>
														</div>
													</div>
													<small id="specHelpBlock" class="form-text text-muted">
														경력사항은 '회사명/직책-시작일-종료일'으로 작성하는것이 원칙이며 이를 어길시 강제 수정됩니다. </small>
											...
											<div class="row">
												<div class="form-group col-md-12 col-12">
													<label>학력/전공</label>
													<div class="input-group">
														<input name="edumajor" type="text" class="form-control"
															placeholder="" aria-label="" id="edumajortext">
														<div class="input-group-append">
															<button class="btn btn-primary" type="button"
																id="edumajorAddBtn">추가하기</button>
														</div>
													</div>
													<small id="edumajorHelpBlock" class="form-text text-muted">
														학력과 전공은 학교/학과 형식으로 작성하는것이 원칙이며 이를 어길시 강제 수정됩니다. </small>
												...
												<div class="form-group col-md-12 col-12">
													...
													<div class="input-group">
														<input name="certificate" type="text" class="form-control"
															placeholder="" aria-label="" id="certificatetext">
														<div class="input-group-append">
															<button class="btn btn-primary" type="button"
																id="cretificateAddBtn">추가하기</button>
														</div>
													</div>
													<small id="certificateHelpBlock"
														class="form-text text-muted"> 자격증명/취득일자/발급기관 형식으로
														작성하는것이 원칙이며 이를 어길시 강제 수정됩니다. </small>
											...
											<div class="row">
												<div class="form-group col-12">
													<label>자기소개</label>
													<textarea id="introduce" name="introduce" rows="30"
														style="min-height: 100px;"
														class="form-control summernote-simple">${profile.introduce}</textarea>
												</div>
											</div>
											<div class="row">
												<div class="form-group mb-0 col-12">
													<div class="custom-control custom-checkbox">
														<input type="checkbox" name="remember"
															...
															class="custom-control-label" for="newsletter">프로필
															수정에 동의합니다</label>
														<div class="text-muted form-text">당신만의 특별한 프로필, 꼼꼼하게
															완성 하셨나요?</div>
													</div>
												</div>
												<div class="form-group">
			...
			<footer class="main-footer">
				<div class="footer-left">
					...
					Design By <a href="/">Doit</a>
				</div>
				<div class="footer-right">beta.v1</div>
			</footer>
		</div>
	</div>
	<!--바디 끝-->
